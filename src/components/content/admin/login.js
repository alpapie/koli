...
export default function Login({auth,setauth}){
    ...
    let [isdisabed,setisdisabed]=useState(false)
   
    let onSubmitdata =async (data)=>{
        setisdisabed(true)
    ...
    return(
        <>
           {!auth? <main class="main">
                <div class="container-fluid">
                    <div class="row row--grid">
                        <div class="col-12">
                            <ul class="breadcrumb">
                                <li class="breadcrumb__item"><a href="index.html">Home</a></li>
                                <li class="breadcrumb__item breadcrumb__item--active">Connection</li>
                            </ul>
                        </div>
                        <div class="col-12">
                            <div class="sign">
                                    ...
                                    <form action="#" class="sign__form" onSubmit={handleSubmit(onSubmitdata)} >
                                        ...
                                        {errors.password && <p className="text-danger">{errors.password.message}</p>}
                                            <input type="password" class="sign__input" placeholder="Password"
                                                                                                {...register("password",{required:"veiller entrer un password",min:{
                                                                                                    value: 8,
                                                                                                    message: 'mot de passe trop court'
                                                                                                }})}
                                            />
                                        </div>
                                        <button class="sign__btn" disabled={isdisabed} type="submit"> {
                                        isdisabed? 
                                        ...
                                        <span class="sign__text">Forgot password?</span>
                                    </form>
                                </div>
                            </div>
                        </div>
