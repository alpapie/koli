                ...
                <div class="ms_header">
                    <div class="ms_top_left">
                        ...
                        <div class="ms_top_trend">
                            <span><a href="#" class="ms_color">KOLI :</a></span> <span class="top_marquee"><a href="#">Les rythmes puissants et les mélodies évocatrices de la musique Peulh </a></span>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="ms_banner_img">
                                    <img src="assets/malickpathesow-resize.png" alt="" class="img-fluid" />
                                </div>
                                <div class="ms_banner_text">
                                    <h1>Koli</h1>
                                    <h1 class="ms_color">La meilleur music au monde !</h1>
                                    <p>Prendre le temps d'écouter la musique Peulh provenant de plusieurs pays d'Afrique <br />
                                        de l'Ouest, notamment le Sénégal, la Guinée et le Mali... <br />
                                        Et se laisser emporter par les mélodies envoûtantes et les rythmes effrénés du Hodu. <br />
                                        Ces styles musicaux, qui sont profondément ancrés dans la culture et les traditions Peulh,<br />
                                        offrent une expérience musicale unique et captivante qui mérite d'être découverte.</p>
                                </div>
                            </div>
                        </div>
                    </div>
